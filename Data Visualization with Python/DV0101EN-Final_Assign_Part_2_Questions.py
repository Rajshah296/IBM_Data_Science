...
app.layout = html.Div([
    ...
    html.H1("Automobile Sales Statistics Dashboard", style={"text-align":'center',"color":'#503D36'}),
...
def update_output_container(input_year, selected_stats):
...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        R_chart2  = dcc.Graph(figure=px.bar(average_sales,x='Vehicle_Type',y='Automobile_Sales',title='Average Automobile Sales per Vehicle Type'))
        
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
        # use groupby to create relevant data for plotting
        exp_rec= recession_data.groupby('Vehicle_Type')['Advertising_Expenditure'].sum(numeric_only=True).reset_index()  
        R_chart3 = dcc.Graph(figure=px.pie(exp_rec,names='Vehicle_Type',values='Advertising_Expenditure',title=f"Total Advertising Expenditure per Vehicle Type during Recession"))
